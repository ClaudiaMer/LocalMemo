...
3) To test if everything works, run `python -m local_memorization.scripts.cifar_color.preprocess`
...
2)  Navigate to `local_memorization/scripts/cifar_color/train_diffusion_model.py` and set `NUM_GENERATED=4000`. Then run 
...
- `scripts` holds the preprocessing, training, evaluation and visualization scripts for specific data sets. 
